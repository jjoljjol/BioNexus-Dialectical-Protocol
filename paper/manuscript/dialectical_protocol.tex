...
\author{Jongbong Park\thanks{J. Park is with DaNAgreen Co., Ltd., Seoul, Republic of Korea (email: jbpark1121@danagreenbio.com). ORCID: 0000-0002-3518-3711.}
}
...
\begin{IEEEkeywords}
Vibe Coding, Bio-inspired AI, Dialectical Protocol, 
Autonomous Code Synthesis, Digital Immune System
\end{IEEEkeywords}
...
The source code, reproducibility scripts, and evaluation benchmarks for the Dialectical Protocol and SAC Algorithm are publicly available at: \url{https://github.com/jjoljjol/BioNexus-Dialectical-Protocol}. This repository includes a comprehensive \texttt{REPRODUCE.md} guide for local deployment using Intel oneAPI and Ollama runtimes.
